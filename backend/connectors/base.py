...
class Connector(abc.ABC):
    ...
    @abc.abstractmethod
    def reschedule_table_reservation(
        self, hospital_id: int, old_appointment_id: int, new_scheduled_at: datetime,
    ) -> Appointment: ...
...
class _UnimplementedTierConnector(Connector):
    ...
    def reschedule_table_reservation(self, hospital_id, old_appointment_id, new_scheduled_at):
        self._not_implemented("reschedule_table_reservation")
