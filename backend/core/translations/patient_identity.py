...
STRINGS: dict[str, dict[Language, str]] = {
    ...
    ADD_PATIENT_OPTION: {"en": "+ Add Guest", "hi": "+ अतिथि जोड़ें"},
    ALL_PATIENTS_OPTION: {"en": "All Guests", "hi": "सभी अतिथि"},
    TOO_MANY_LINKED_PATIENTS: {
        "en": "This phone number already has 5 linked guests — the maximum allowed. "
              "Unlink someone first if you'd like to add another.",
        "hi": "इस फोन नंबर पर पहले से ही 5 अतिथि जुड़े हुए हैं — यह अधिकतम सीमा है। "
    ...
    # race.
    DUPLICATE_SELF_LINK: {
        "en": "You already have a \"Myself\" profile linked at this restaurant. Please try again to add someone else.",
        "hi": "इस रेस्तरां में आपकी \"मैं खुद\" प्रोफ़ाइल पहले से ही जुड़ी हुई है। कृपया किसी और को जोड़ने के लिए फिर से प्रयास करें।",
    },
    ...
    PATIENT_ALREADY_LINKED: {
        "en": "{name} is already in your guest list at this restaurant -- no need to add them again.",
        "hi": "{name} इस रेस्तरां में आपकी अतिथि सूची में पहले से मौजूद हैं -- उन्हें दोबारा जोड़ने की ज़रूरत नहीं है।",
    },
    ...
    PATIENT_HEADER_LABEL: {"en": "Guest:", "hi": "अतिथि:"},
    ...
    PATIENT_CODE_LABEL: {"en": "Guest ID:", "hi": "अतिथि आईडी:"},
    PATIENT_SELECTOR_PROMPT: {
        "en": "Who are you accessing Dine Connect for?",
        "hi": "आप Dine Connect किसके लिए इस्तेमाल कर रहे हैं?",
    },
    MANAGE_PATIENTS_SHORT: {"en": "Manage Guests", "hi": "अतिथि प्रबंधित करें"},
    ADD_PATIENT_SHORT: {"en": "Add Guest", "hi": "अतिथि जोड़ें"},
    BACK_TO_MENU_OPTION: {"en": "Back to Menu", "hi": "मेनू पर वापस"},
    REGISTRATION_BLOCKED_CONTACT_HOSPITAL: {
        "en": "This phone number already has the maximum number of linked guests. Please contact the restaurant directly.",
        "hi": "इस फोन नंबर पर पहले से ही अधिकतम अतिथि जुड़े हुए हैं। कृपया सीधे रेस्तरां से संपर्क करें।",
    },
    PATIENT_CONTEXT_INVALID: {
        "en": "This guest is no longer linked to this number. Please send any message to start over.",
        "hi": "यह अतिथि अब इस नंबर से जुड़ा नहीं है। कृपया फिर से शुरू करने के लिए कोई भी संदेश भेजें।",
    },
    ...
    DUPLICATE_PATIENT_FOUND: {
        "en": "We found an existing restaurant profile that may match:\n\n*{name}*\nGuest ID: {patient_code}\n\n"
              "Would you like to link this profile?",
        "hi": "हमें एक मौजूदा रेस्तरां प्रोफ़ाइल मिली जो मेल खा सकती है:\n\n*{name}*\nअतिथि आईडी: {patient_code}\n\n"
    ...
    ASK_RELATIONSHIP: {
        "en": "What is this guest's relationship to you?",
        "hi": "यह अतिथि आपसे किस रिश्ते में है?",
    },
    ...
    SINGLE_PATIENT_CONFIRM: {
        "en": "🍽️ Welcome to Dine Connect\n\nCurrent Guest: {patient_name}\nGuest ID: {patient_code}\n\nHow can we assist you today?",
        "hi": "🍽️ Dine Connect में आपका स्वागत है\n\nवर्तमान अतिथि: {patient_name}\nअतिथि आईडी: {patient_code}\n\nहम आज आपकी कैसे सहायता कर सकते हैं?",
    },
    ...
    PLEASE_ADD_NEW_PATIENT: {
        "en": "Please add new guest",
        "hi": "कृपया नया अतिथि जोड़ें",
    },
    ...
    MULTI_PATIENT_SELECTOR_PROMPT: {
        "en": "Welcome to Dine Connect.\n\nPlease select the guest.",
        "hi": "Dine Connect में आपका स्वागत है।\n\nकृपया अतिथि का चयन करें।",
    },
